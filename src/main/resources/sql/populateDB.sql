...
VALUES (120000, 110000, 'Zerowatt', 'Электрическая варочная панель', 7550, 5, now(), true, 101000),
       (120001, 110000, 'Hansa', 'Индукционная варочная панель', 16990, 3, now(), true, 101001),
       (120002, 110001, 'Philips', 'Кофеварка капельная', 3590, 4, now(), true, 101002),
       (120003, 110001, 'EVOLUTION', 'Вертикальный пылесос', 3142, 2, now(), true, 101003);
